...
export default function Certificate() {
  ...
  return (
    <div>
      <h1 className="text-center font-semibold text-5xl p-4"> Certificates</h1>
      <div className="flex flex-row m-10 mx-20 flex-wrap my-2 ">
        {certificateData.map((data) => (
          <a
            href={data.link}
            target="_blank"
            key={data.id}
            className={`w-1/4 m-14 rounded-lg border border-grey shadow-xl transition-transform duration-300 ${
